  ...
  return (
    ...
    >
                ...
                <div className="flex flex-col gap-8 text-white">
                  ...
                  <div>
                    <Link
                      ...
                      target="_blank"
                    >
                      <button className="p-2 text-sm md:p-4 md:text-md lg:text-lg bg-white text-gray-600 font-semibold rounded-lg overflow-hidden drop-shadow-[0_5px_5px_rgba(0,0,0,0.5)]">
                        Github
                      </button>
                    </Link>
                  </div>
      ...
      <div className=" w-screen h-screen flex flex-col gap-16 items-center justify-center text-top">
        <h1 className="text-6xl">Thank you for your visit!</h1>
        <motion.div
          whileHover={{
            scale: [1.1, 1],
          }}
          ...
          className="relative px-8 flex gap-4 w-full grid justify-center rounded-lg drop-shadow-[0_5px_5px_rgba(0,0,0,0.5)]"
        >
          <Link href="/contact">
